...
import 'package:movie111/UI/auth/view_model/providers/token_provider.dart';
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (context) => SelectedCatProvider()),
        ChangeNotifierProvider(
    ...
    return ScreenUtilInit(
      ...
      builder:
          (context, child) => MaterialApp(
            ...
            locale:
                context.watch<SwitchProvider>().isActive == false
                    ? Locale('en')
                    : Locale('ar'),
