...
import 'package:movie111/UI/main_layer/tabs/searchTab/view_model/search_movies_state.dart';
import 'package:movie111/UI/main_layer/tabs/searchTab/view/widgets/custom_search_field.dart';
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            children: [
              CustomSearchField(onChanged: _onSearch),
